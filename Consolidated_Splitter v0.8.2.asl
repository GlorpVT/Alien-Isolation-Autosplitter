state("AI", "Steam") 									// Script Written by Spazdmo (Any Issues, Please place a query on #Support in the Alien: Isolation Discord)
{
...
#region ToolTips
	...
	settings.SetToolTip("DEVTOOLS","ASL Var Viewer is REQUIRED to View These");
...
if(settings["DEVTOOLS"] == true && (settings["dlc"] == false || settings["campaign"] == false || settings["ils"] == false || settings["CatExt"] == false)){
