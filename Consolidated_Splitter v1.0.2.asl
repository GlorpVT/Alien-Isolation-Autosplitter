...
state("AI", "Epic") // Will eventually get Microsoft Version to get all versions available
{
	...
	byte loadingIcon : 0x1366CAC, 0xF50, 0x1D;
...
// state("AI", "Xbox Gamepass") // this is gross
// {
// 	int fadeState : 0x15E2664;
// 	float fadeNum : 0x15E2668;
// 	byte gameFlowState : 0x17EEBD0, 0x8;
// 	int levelManagerState : 0x018A7108, 0xAC, 0x70;
//  short SaveIcon : ;
// 	byte loadingIcon : ;
//  int missionNum : 0x01DC3750, 0x14;
// 	string25 Map : 0x0198EA88, 0x1A0;
//  float MainMenu : 0x01FAC5D8, 0x38, 0x4D8, 0xFF0, 0x330;
//  float FinalLevel : 0x01FAC5D8, 0x38, 0x4D8, 0xFF0, 0x334;
// 	float loadingScreen : 0x01FAC5D8, 0x38, 0x4D8, 0xFF0, 0x338;
// }
startup
{	
    vars.loading = false;
