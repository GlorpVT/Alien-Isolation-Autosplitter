...
state("AI", "GOG") 
{
	int fadeState : 0xB305A4, 0x624, 0x470, 0x74;
	float fadeNum : 0xB305A4, 0x624, 0x470, 0x78;
	byte gameFlowState : 0x12506FC, 0x8;
	int levelManagerState : 0x1BDD628, 0x54;
	int missionNum : 0x13691C0, 0x280;
	string25 Map : 0x17FE8B4, 0x4F4, 0x168;
    	float PosX : 0x3FF598, 0x80;
	float PosY : 0x3FF598, 0x84;
    	float PosZ : 0x3FF598, 0x88;
}
...
#region Starting Checker
	if((settings["allmissions"] == true && settings["campaign"] == true) && vars.fadetrigger){return true;} // Detects if PLAYER is starting All Missions
